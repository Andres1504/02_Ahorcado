...
public class ServidorTCP {
	...
	static private final String[] palabrasAhorcado = {"moñoñongo", "poste", "estructuras", "karim", "ana laura", "universidad lasalle", "odiame mas", "ingenieria en software","internet", "goya goya", "pumas", "mickey mouse", "lista circular", "lista ligada","base de datos", "capas", "redes", "no nos de moñoñongo", "en esta si paso",};
